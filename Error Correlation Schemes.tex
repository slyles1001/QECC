...
We can use the IBM's on line quantum computer (with noise) to implement our scheme.
...
when $n$ is odd. In particular, we use the IBM's on line quantum computer to do the
...
Here we illustrate our hybrid quantum error correction scheme for $n$-qubit system
when $n$ is even. In particular, we use the IBM's on line quantum computer to do the
