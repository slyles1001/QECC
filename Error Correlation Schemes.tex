...
We use IBM's online quantum computers to indicate implement our scheme. We compare two different machines: Tenerife (\verb|ibmqx4|, pink in graphs) and Yorktown (\verb|ibmqx2|, blue) to show the discrepancy of prediction quality between the two. Yorktown has more than 9$\times$ the gate error of Tenerife, and 2.4$\times$ the readout error. This can be observed in the graphs of Table \ref{tbl:sig0}.

% \medskip
% \begin{figure}
%     \centering
%     \includegraphics[height=1.35in,width=1.5in]{img/fixed_qecc3_00.png}
%     \includegraphics[height=1.35in,width=1.5in]{img/fixed_qecc3_01.png}
%     \includegraphics[height=1.35in,width=1.5in]{img/fixed_qecc3_10.png}
%     \includegraphics[height=1.35in,width=1.5in]{img/fixed_qecc3_11.png}
